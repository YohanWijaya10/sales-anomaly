...
TRUNCATE TABLE leaders CASCADE;

-- ============================================
-- LEADERS (3 leaders)
-- ============================================
INSERT INTO leaders (id, code, name, active) VALUES
  ('aaaa1111-1111-1111-1111-111111111111', 'LD001', 'Raka Pramudya', true),
  ('bbbb2222-2222-2222-2222-222222222222', 'LD002', 'Sari Kartika', true),
  ('cccc3333-3333-3333-3333-333333333333', 'LD003', 'Hendra Wijaya', true),
  ('dddd4444-4444-4444-4444-444444444444', 'LD004', 'Maya Lestari', true),
  ('eeee5555-5555-5555-5555-555555555555', 'LD005', 'Rizal Aditya', true);

-- ============================================
-- REGIONS (3 regions)
-- ============================================
INSERT INTO regions (id, code, name, leader_id) VALUES
  ('dddd1111-1111-1111-1111-111111111111', 'RG-JKT', 'Jakarta', 'aaaa1111-1111-1111-1111-111111111111'),
  ('eeee2222-2222-2222-2222-222222222222', 'RG-BDG', 'Bandung', 'bbbb2222-2222-2222-2222-222222222222'),
  ('ffff3333-3333-3333-3333-333333333333', 'RG-SBY', 'Surabaya', 'cccc3333-3333-3333-3333-333333333333'),
  ('99991111-1111-1111-1111-111111111111', 'RG-MDN', 'Medan', 'dddd4444-4444-4444-4444-444444444444'),
  ('aaaa2222-2222-2222-2222-222222222222', 'RG-MLG', 'Malang', 'dddd4444-4444-4444-4444-444444444444'),
  ('bbbb3333-3333-3333-3333-333333333333', 'RG-MKS', 'Makassar', 'eeee5555-5555-5555-5555-555555555555'),
  ('cccc4444-4444-4444-4444-444444444444', 'RG-SMG', 'Semarang', 'eeee5555-5555-5555-5555-555555555555');

-- ============================================
-- SALESMEN (3 salesmen with different behaviors)
-- ============================================
INSERT INTO salesmen (id, code, name, leader_id, region_id, active) VALUES
  ('11111111-1111-1111-1111-111111111111', 'SM001', 'Andi Pratama', 'aaaa1111-1111-1111-1111-111111111111', 'dddd1111-1111-1111-1111-111111111111', true), -- Normal performer
  ('22222222-2222-2222-2222-222222222222', 'SM002', 'Budi Santoso', 'aaaa1111-1111-1111-1111-111111111111', 'dddd1111-1111-1111-1111-111111111111', true), -- Many visits, zero sales (RF_LOW_EFFECTIVENESS)
  ('33333333-3333-3333-3333-333333333333', 'SM003', 'Citra Wulandari', 'bbbb2222-2222-2222-2222-222222222222', 'eeee2222-2222-2222-2222-222222222222', true), -- Repeated same outlet (RF_LOW_COVERAGE)
  ('44444444-4444-4444-4444-444444444444', 'SM004', 'Dewi Lestari', 'bbbb2222-2222-2222-2222-222222222222', 'eeee2222-2222-2222-2222-222222222222', true),
  ('55555555-5555-5555-5555-555555555555', 'SM005', 'Eko Saputra', 'cccc3333-3333-3333-3333-333333333333', 'ffff3333-3333-3333-3333-333333333333', true),
  ('66666666-6666-6666-6666-666666666666', 'SM006', 'Farhan Maulana', 'cccc3333-3333-3333-3333-333333333333', 'ffff3333-3333-3333-3333-333333333333', true),
  ('77777777-7777-7777-7777-777777777777', 'SM007', 'Gita Permata', 'dddd4444-4444-4444-4444-444444444444', '99991111-1111-1111-1111-111111111111', true),
  ('88888888-8888-8888-8888-888888888888', 'SM008', 'Hafiz Ramadhan', 'dddd4444-4444-4444-4444-444444444444', 'aaaa2222-2222-2222-2222-222222222222', true),
  ('99999999-9999-9999-9999-999999999999', 'SM009', 'Intan Sari', 'eeee5555-5555-5555-5555-555555555555', 'bbbb3333-3333-3333-3333-333333333333', true),
  ('abababab-abab-abab-abab-abababababab', 'SM010', 'Joko Winarto', 'eeee5555-5555-5555-5555-555555555555', 'cccc4444-4444-4444-4444-444444444444', true),
  ('cdcdcdcd-cdcd-cdcd-cdcd-cdcdcdcdcdcd', 'SM011', 'Kezia Putri', 'aaaa1111-1111-1111-1111-111111111111', 'dddd1111-1111-1111-1111-111111111111', true),
  ('efefefef-efef-efef-efef-efefefefefef', 'SM012', 'Lukman Hakim', 'bbbb2222-2222-2222-2222-222222222222', 'eeee2222-2222-2222-2222-222222222222', true),
  ('10101010-1010-1010-1010-101010101010', 'SM013', 'Mega Pratiwi', 'cccc3333-3333-3333-3333-333333333333', 'ffff3333-3333-3333-3333-333333333333', true),
  ('12121212-1212-1212-1212-121212121212', 'SM014', 'Nanda Saputri', 'dddd4444-4444-4444-4444-444444444444', '99991111-1111-1111-1111-111111111111', true),
  ('13131313-1313-1313-1313-131313131313', 'SM015', 'Oki Firmansyah', 'eeee5555-5555-5555-5555-555555555555', 'bbbb3333-3333-3333-3333-333333333333', true);
